...
sealed class AppEditorComponentListEvent {
  const AppEditorComponentListEvent();
}

/// The event that is triggered when the AppEditorComponentList widget is
/// started.
class AppEditorComponentListStartedEvent extends AppEditorComponentListEvent {
  const AppEditorComponentListStartedEvent();
}
