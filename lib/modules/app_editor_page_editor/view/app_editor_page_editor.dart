...
/// [AppEditorPageEditor] is a StatelessWidget that provides
...
class AppEditorPageEditor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const AppEditorPageEditorView(),
    );
  }
}

/// [AppEditorPageEditorView] is a StatelessWidget that displays
/// the app editor page editor with drag and drop support.
class AppEditorPageEditorView extends StatelessWidget {
  /// Creates a new instance of [AppEditorPageEditorView].
  const AppEditorPageEditorView({super.key});
